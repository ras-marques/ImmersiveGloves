...
class IModelManager {
 public:
  ...
  virtual AnimationData GetAnimationDataByInterp(const HandSkeletonBone& boneIndex, float f) const = 0;
  virtual AnimationData GetAnimationDataByKeyframes(const HandSkeletonBone& boneIndex, const int firstKeyframe, const int lastKeyframe) const = 0;
...
class GLTFModelManager : public IModelManager {
 public:
  ...
  AnimationData GetAnimationDataByInterp(const HandSkeletonBone& boneIndex, const float f) const override;
  AnimationData GetAnimationDataByKeyframes(const HandSkeletonBone& boneIndex, const int firstKeyframe, const int lastKeyframe) const override;
